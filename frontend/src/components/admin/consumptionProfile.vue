  ...
  data(){
    return {
      forms: {
        ...
        material_name: {type: 'dropdown', name: 'اسم ماده',title: 'محل اسم ماده', data: '', value: ''},
        unit: {type: 'dropdown', name: 'واحد',title: 'واحد', data: '', value: ''},
        quantity: {type: 'input', name: 'کمیت(مقدار)',title: 'کمیت(مقدار)', data: '', value: ''},
      },
      forms_two: {
        consumption_list: {type:'list', name: 'اسم راننده فرک لیفت',title: 'اسم راننده فرک لیفت', value: ''},
...
<template>
  <Card title="اضافه کردن تامین کننده جدید">
