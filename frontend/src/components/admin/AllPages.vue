  ...
  <Card title="All Pages">
    <div class="flex flex-col gap-2 justify-center items-center">
      <template v-for="route in routes" :key="route.name">
        <button type="button" class="w-44 block text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
