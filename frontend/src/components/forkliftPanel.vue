...
<template>
  <Card v-if="btnPanel" title="پنل forklift">
    <div class="flex flex-col gap-2 justify-center items-center">
      <button v-for="btn in btns" @click="activePanel(btn)" type="button" class="inline-flex justify-center w-48 px-2 py-1.5 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">
        {{btn.name}}
      </button>
    </div>
  </Card>
