...
# Values for the test
#counter = 1
start_counter = 2  # Starting point (e.g., Customer or Supplier 3)
cycle = 3  # How many cycles to run
reel_production_quantity = 3
################################### SETTINGS ####################################
w1 = 36000
w2 = 16000
net = 20000
...
file_handler = logging.FileHandler('FullCycle.log')
...
def addShipment_IN(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk IN  a s Cy"  + str(counter), counter)
    wait(1)
...
def addUnloaded_IN(counter):
    ...
    fillInputBox(FORK_USERNAME_IMAGE, "unFK IN Cy:" + str(counter), counter)
    wait(1)
def addWeight2_IN(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk IN w2 by Cy" + str(counter), counter)
    wait(1)
def addPO_IN(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk c PO by Cy"  + str(counter), counter)
    wait(1)
...
def addShipment_OUT(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk a OUT s Cy"  + str(counter), counter)
    wait(1)
def addWeight1_OUT(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk OUT w1 by Cy"  + str(counter), counter)
    wait(1)
...
def addWeight2_OUT(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk OUT w2 by Cy" + str(counter), counter)
    wait(1)
def addSO_OUT(counter):
    ...
    fillInputBox(USERNAME_IMAGE, "nk c SO by Cy" + str(counter), counter)
    wait(1)
#################################################################################
...
#################################################################################
try:
    for counter in range(start_counter, start_counter + cycle):
    #for counter in range(counter, cycle):
    #while counter <= cycle:
        #################################################################################
        #################################################################################
        #                                     IN
        ...
        counter += 1
        wait(1)  # Wait for X seconds before the next iteration
