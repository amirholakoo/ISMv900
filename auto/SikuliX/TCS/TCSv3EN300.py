...
max_entry = 4 #int(input("Enter the max entry (from counter 1 to counter X): "))
################################### SETTINGS ####################################
w1 = 36000
w2 = 16000
net = 20000
...
file_handler = logging.FileHandler('TCSv3EN.log')
...
################################
# Define constants for the images
CUS_NAME_BOX_IMAGE = Pattern("NAME_BOX_IMAGE.png").similar(0.67)
ADDRESS_BOX_IMAGE = "ADDRESS_BOX_IMAGE.png"
PHONE_BOX_IMAGE = "PHONE_BOX_IMAGE.png"
COMMENT_BOX_IMAGE = "COMMENT_BOX_IMAGE.png"
################################
SUP_NAME_BOX_IMAGE = Pattern("SUP_NAME_BOX_IMAGE.png").similar(0.65)
################################
...
def addTruck_FA(counter):
    ...
    if exists(RED_INDICATOR_IMAGE):
        ...
        # Fill out the form
        switchKeyboardLayout()
        fillInputBox(FIRST_BOX_IMAGE, "اقای زاننده  " + str(counter), counter)
        switchKeyboardLayout()
        fillInputBox(SECOND_BOX_IMAGE, "Lic Nm. " + str(counter), counter)
        switchKeyboardLayout()
        fillInputBox(THIRD_BOX_IMAGE, "۰۹۱۲۰۰۰۰۰۰" + str(counter), counter)
        switchKeyboardLayout()
        fillInputBox(LAST_BOX_IMAGE, "نام کاربری اضافه کردن کامیون " + str(counter), counter)
        add_And_confirm()
