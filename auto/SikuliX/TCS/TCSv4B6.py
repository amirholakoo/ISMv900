...
REEL_WIDTH_IMG = Pattern("REEL_WIDTH_IMG.png").targetOffset(10,3)
...
Anbar_Salon_Tolid_IMG = Pattern("Anbar_Salon_Tolid_IMG.png").similar(0.86).targetOffset(-43,0)
...
Shipments_DB_IMG = "Shipments_DB_IMG.png"
...
Anbar_Salon_Tolid_DB_IMG = "Anbar_Salon_Tolid_DB_IMG.png"
Sales_DB_IMG = "Sales_DB_IMG.png"
ConsumptionDB_DB_IMG = "ConsumptionDB_DB_IMG.png"
